...
train_dataset1, valid_dataset1, train_debug1, valid_debug1 = get_captioning_datasets(config['dataset']['cocoCaption'], image_processor, tokenizer, tokenizer_max_length=config['training']['stage1']['tokenizer_max_length'])
train_dataset2, valid_dataset2, train_debug2, valid_debug2 = get_captioning_datasets(config['dataset']['flickr'], image_processor, tokenizer, tokenizer_max_length=config['training']['stage1']['tokenizer_max_length'])
train_dataset3, valid_dataset3, train_debug3, valid_debug3 = get_captioning_datasets(config['dataset']['llava'], image_processor, tokenizer, tokenizer_max_length=config['training']['stage1']['tokenizer_max_length'])
train_dataset4, valid_dataset4, train_debug4, valid_debug4 = get_captioning_datasets(config['dataset']['textCaps'], image_processor, tokenizer, tokenizer_max_length=config['training']['stage1']['tokenizer_max_length'])
...
optimizer = torch.optim.AdamW(
    trainable_params, 
    lr=float(config['training']['stage1']['learning_rate']), 
...
trainer = CustomTrainer(
        ...
        save_dir_root=config['path']['save_dir']['stage1'],
